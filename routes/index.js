...
router.get("/scrape-salary", async function (req, res, next) {
  ...
  if (req.query.county === "Hauts-de-France") {
    ...
    city = "Bordeaux";
  } else if (req.query.county === "Auvergne-Rhones-Alpes") {
    city = "Lyon";
  } else if (req.query.county === "Occitanie") {
    city = "Toulouse";
  } else if (req.query.county === "Provences-Alpes-Cote d'Azur") {
    city = "Marseille";
  } else if (req.query.county === "Corse") {
    city = "Ajaccio";
  } else {
    city = "Fort-de-France";
  } // valeur pour l'input "Départements et régions d'outre-mer" venant du front
